...
public class SelfLearningLinearOperatorHeuristic extends SelfLearningHeuristic<List<Double>> {
    ...
    public SelfLearningLinearOperatorHeuristic(Heuristic<List<Double>> heuristic, AbstractMemory<List<Double>> memory, double mutationRate, RealDistribution realDistribution, RealDistribution velocityDistribution, RealDistribution thresholdDistribution) {
    ...
    protected SelfLearningHeuristic<List<Double>> makeCopy() {
        return new SelfLearningLinearOperatorHeuristic(heuristic, memory, mutationRate, realDistribution, velocityDistribution, thresholdDistribution);
    }
}
